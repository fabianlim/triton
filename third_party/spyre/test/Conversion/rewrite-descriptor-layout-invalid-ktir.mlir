...
tt.func @unexpected_access_tile_user(%arg0: !tt.ptr<f32>) {
  ...
  %1 = ktdp.construct_memory_view %0, sizes: [64, 64], strides: [64, 1] {coordinate_set = #set2, memory_space = #ktdp.spyre_memory_space<HBM>} : memref<64x64xf32>
...
tt.func @cannot_derive_static_block_shape(%arg0: !tt.ptr<f32>) {
  ...
  %c0b_i32 = arith.constant 0 : i32
  %0 = builtin.unrealized_conversion_cast %arg0 : !tt.ptr<f32> to index
  %1 = ktdp.construct_memory_view %0, sizes: [64, 64], strides: [64, 1] {coordinate_set = #set5, memory_space = #ktdp.spyre_memory_space<HBM>} : memref<64x64xf32>
  %2 = builtin.unrealized_conversion_cast %1 : memref<64x64xf32> to !tt.tensordesc<64x64xf32>
  tt.spyre_tensor_layout %2 {phys_arg = array<i64: 64, 0, 64>, phys_op = array<i64: 1, 0, 2>, phys_src = array<i64: 1, 0, 1>} : <64x64xf32>
  %3 = arith.index_cast %c0_i32 : i32 to index
  %4 = arith.index_cast %c0b_i32 : i32 to index
...
tt.func @stick_dim_too_small(%arg0: !tt.ptr<f32>) {
  ...
  %c0b_i32 = arith.constant 0 : i32
  %0 = builtin.unrealized_conversion_cast %arg0 : !tt.ptr<f32> to index
  %1 = ktdp.construct_memory_view %0, sizes: [64, 32], strides: [32, 1] {coordinate_set = #set6, memory_space = #ktdp.spyre_memory_space<HBM>} : memref<64x32xf32>
...
tt.func @indirect_rank3(%arg0: !tt.ptr<f32>, %idx_ptr: !tt.ptr<i32>) {
  ...
  %0 = builtin.unrealized_conversion_cast %arg0 : !tt.ptr<f32> to index
  %1 = ktdp.construct_memory_view %0, sizes: [32, 64, 16], strides: [1024, 16, 1] {coordinate_set = #set7a, memory_space = #ktdp.spyre_memory_space<HBM>} : memref<32x64x16xf32>
  ...
  %4 = ktdp.construct_memory_view %3, sizes: [32], strides: [1] {coordinate_set = #set7b, memory_space = #ktdp.spyre_memory_space<HBM>} : memref<32xi32>
...
tt.func @indirect_dim1_is_indirect(%arg0: !tt.ptr<f32>, %idx_ptr: !tt.ptr<i32>) {
  %c0 = arith.constant 0 : index
  %0 = builtin.unrealized_conversion_cast %arg0 : !tt.ptr<f32> to index
  %1 = ktdp.construct_memory_view %0, sizes: [64, 32], strides: [32, 1] {coordinate_set = #set8a, memory_space = #ktdp.spyre_memory_space<HBM>} : memref<64x32xf32>
  %2 = builtin.unrealized_conversion_cast %1 : memref<64x32xf32> to !tt.tensordesc<64x32xf32>
  tt.spyre_tensor_layout %2 {phys_arg = array<i64: 0, 0>, phys_op = array<i64: 0, 0>, phys_src = array<i64: 0, 1>} : <64x32xf32>
  %3 = builtin.unrealized_conversion_cast %idx_ptr : !tt.ptr<i32> to index
  %4 = ktdp.construct_memory_view %3, sizes: [32], strides: [1] {coordinate_set = #set8b, memory_space = #ktdp.spyre_memory_space<HBM>} : memref<32xi32>
...
tt.func @indirect_stick_split_row(%arg0: !tt.ptr<f32>, %idx_ptr: !tt.ptr<i32>) {
  %c0 = arith.constant 0 : index
  %0 = builtin.unrealized_conversion_cast %arg0 : !tt.ptr<f32> to index
  %1 = ktdp.construct_memory_view %0, sizes: [32, 128], strides: [128, 1] {coordinate_set = #set9a, memory_space = #ktdp.spyre_memory_space<HBM>} : memref<32x128xf32>
  ...
  %3 = builtin.unrealized_conversion_cast %idx_ptr : !tt.ptr<i32> to index
  %4 = ktdp.construct_memory_view %3, sizes: [32], strides: [1] {coordinate_set = #set9b, memory_space = #ktdp.spyre_memory_space<HBM>} : memref<32xi32>
...
tt.func @indirect_dynamic_block_shape(%arg0: !tt.ptr<f32>, %idx_ptr: !tt.ptr<i32>) {
  %c0 = arith.constant 0 : index
  %0 = builtin.unrealized_conversion_cast %arg0 : !tt.ptr<f32> to index
  %1 = ktdp.construct_memory_view %0, sizes: [512, 128], strides: [128, 1] {coordinate_set = #set10a, memory_space = #ktdp.spyre_memory_space<HBM>} : memref<512x128xf32>
  ...
  %3 = builtin.unrealized_conversion_cast %idx_ptr : !tt.ptr<i32> to index
  %4 = ktdp.construct_memory_view %3, sizes: [32], strides: [1] {coordinate_set = #set10b, memory_space = #ktdp.spyre_memory_space<HBM>} : memref<32xi32>
...
tt.func @indirect_unexpected_user(%arg0: !tt.ptr<f32>, %idx_ptr: !tt.ptr<i32>) {
  %c0 = arith.constant 0 : index
  %0 = builtin.unrealized_conversion_cast %arg0 : !tt.ptr<f32> to index
  %1 = ktdp.construct_memory_view %0, sizes: [512, 128], strides: [128, 1] {coordinate_set = #set11a, memory_space = #ktdp.spyre_memory_space<HBM>} : memref<512x128xf32>
  %2 = builtin.unrealized_conversion_cast %1 : memref<512x128xf32> to !tt.tensordesc<512x128xf32>
  tt.spyre_tensor_layout %2 {phys_arg = array<i64: 64, 0, 64>, phys_op = array<i64: 1, 0, 2>, phys_src = array<i64: 1, 0, 1>} : <512x128xf32>
  %3 = builtin.unrealized_conversion_cast %idx_ptr : !tt.ptr<i32> to index
  %4 = ktdp.construct_memory_view %3, sizes: [32], strides: [1] {coordinate_set = #set11b, memory_space = #ktdp.spyre_memory_space<HBM>} : memref<32xi32>
...
module {
  tt.func @matmul_r6_shared_stickified(%arg0: !tt.ptr<f32>, %arg1: !tt.ptr<f32>, %arg2: !tt.ptr<f32>) {
    %c0_i32 = arith.constant 0 : i32
    %0 = builtin.unrealized_conversion_cast %arg0 : !tt.ptr<f32> to index
    %1 = ktdp.construct_memory_view %0, sizes: [64, 128], strides: [128, 1] {coordinate_set = #set12a, memory_space = #ktdp.spyre_memory_space<HBM>} : memref<64x128xf32>
    ...
    %8 = ktdp.construct_memory_view %7, sizes: [128, 64], strides: [64, 1] {coordinate_set = #set12b, memory_space = #ktdp.spyre_memory_space<HBM>} : memref<128x64xf32>
    ...
    %14 = ktdp.construct_memory_view %13, sizes: [64, 64], strides: [64, 1] {coordinate_set = #set12c, memory_space = #ktdp.spyre_memory_space<HBM>} : memref<64x64xf32>

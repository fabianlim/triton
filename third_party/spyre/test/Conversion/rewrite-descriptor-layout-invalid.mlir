...
// Test 1: phys_src out of range — phys_src[0]=2 but the logical descriptor is
// rank-2 (valid indices are 0 and 1).
module {
tt.func @phys_src_out_of_range(%ptr: !tt.ptr<f32>, %out: !tt.ptr<f32>) {
  ...
  // phys_src[0]=2 is out of range for a 2-D descriptor
  // expected-error @below {{spyre_tensor_layout: phys_src out of range}}
  tt.spyre_tensor_layout %desc {phys_src = array<i64: 2, 0, 1>, phys_op = array<i64: 1, 0, 2>, phys_arg = array<i64: 64, 0, 64>} : !tt.tensordesc<64x64xf32>
  %d = tt.descriptor_load %desc[%c0_i32, %c0_i32] : !tt.tensordesc<64x64xf32> -> tensor<64x64xf32>
  %out_desc = tt.make_tensor_descriptor %out, [%c64_i32, %c64_i32], [%c64_i64, %c1_i64]
      : !tt.ptr<f32>, !tt.tensordesc<64x64xf32>
...
// Test 2: block extent of stick dim is smaller than the stick size.
...
// Test 3: stick-splitting the indirect (gather) row dim is not supported.
